...
const SHOPS = [
  {
    ...
    shop_name: 'ABC Xerox & Digital Services',
    slug: 'abc-xerox',
    phone: '9876543210',
    whatsapp_number: '9876543210',
    email: 'owner@abcxerox.com',
    address: 'Shop 4, University Shopping Complex, Navrangpura',
    city: 'Ahmedabad',
    state: 'Gujarat',
    pincode: '380009',
    is_active: true,
  },
  {
    ...
    address: '12 Ring Road Market, Majura Gate',
    city: 'Surat',
    state: 'Gujarat',
    pincode: '395002',
    is_active: true,
